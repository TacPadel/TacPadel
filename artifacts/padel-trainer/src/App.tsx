...
export default function App() {
  ...
  const isShotCorrect =
    ...
    scenario.validShots.some(
      (valid) => valid === selectedShot || (selectedShot === "LOB" && valid.includes("LOB")) || (selectedShot === "VOLLEY" && valid.includes("VOLLEY"))
    );
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-background text-foreground flex flex-col items-center justify-center p-4 lg:p-8 font-sans">
              ...
              <div className="grid grid-cols-4 grid-rows-4 h-full w-full gap-1">
                {COURT_ZONES.map((zone) => {
                  ...
                  if (isSelected && !hasSubmitted) {
                    ...
                    if (isBest) {
                      zoneClass =
                        "border-primary bg-primary/60 shadow-[0_0_15px_rgba(0,255,150,0.6)]";
